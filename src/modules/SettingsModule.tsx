...
const FIELDS: { key: keyof Omit<SettingsType, "id">; label: string; group: string }[] = [
  ...
  { key: "day_tour_rate", label: "Day Tour Rate (Non-Exclusive)", group: "Non-Exclusive Rate Settings" },
  { key: "overnight_rate", label: "Overnight Rate (Non-Exclusive)", group: "Non-Exclusive Rate Settings" },
  ...
  { key: "function_hall_rate_per_day", label: "Function Hall Rate (per day)", group: "Function Hall Settings" },
];
